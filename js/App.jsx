...
export default function App() {
    ...
    const [displayMode, setDisplayMode] = useState(userData ? userData.displayMode : "dark-mode");
    ...
    return (
        <DisplayModeCtx value={ {displayMode: displayMode, setDisplayMode: setDisplayMode} }  >
            <MainWindow {...data}>
                <ChatWindow {...data} />
            </MainWindow>
        </DisplayModeCtx>
